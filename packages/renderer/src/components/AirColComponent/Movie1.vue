...
<style>
  ...
  .air-col-movie1__pic img {
    width: 100%;
    height: 100%;
  }

  .air-col-movie1__content + .air-col-movie1__pic {
    margin-left: 12px;
  }

  .air-col-movie1__content {
    z-index: 3;
    flex: 1;
    display: flex;
  ...
  .air-col-movie1__title {
    font-size: 1.5rem;
    font-weight: bold;
  }

  .air-col-movie1__desc {
    font-size: 1rem;
  }
</style>
