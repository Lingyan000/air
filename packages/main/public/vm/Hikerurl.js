...
(function (windows) {
  ...
  $.fn = {
    ...
    rule() {
      return (
        this.param1 + head.rule + (this.param2 || 'js:' + base64Func(this, toStringFun(arguments)))
      );
    },
    lazyRule() {
      return (
        ...
        this.param2 +
        '.js:' +
        base64Func(this, toStringFun(arguments))
      );
    },
    x5Rule() {
      return (
        ...
        JSON.stringify(this.param1) +
        ';' +
        toStringFun(arguments)
      );
    },
    input() {
      return (
